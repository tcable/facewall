...
import static uk.co.o2.facewall.data.dao.database.query.FacewallQueryResultsMapperTest.MockCypherResultsBuilder.results;
import static uk.co.o2.facewall.data.dao.database.query.FacewallQueryResultsMatcher.areQueryResults;
import static uk.co.o2.facewall.data.dao.database.query.PersonNodeKey.newPersonNodeKey;
import static uk.co.o2.facewall.data.dao.database.query.QueryResultRowMatcher.aRow;
